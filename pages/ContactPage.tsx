...
// It includes a simple contact form and links to social media.
...
function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    const subject = `Contact from ${name || 'Portfolio Visitor'}`;
    const body = message;
    window.location.href = `mailto:vikasbg.png@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
  };
    ...
    <AnimatedPage>
      <div className="min-h-screen flex items-center justify-center p-4 md:p-8 text-white">
        <div className="container mx-auto max-w-lg text-center">
            ...
            >
                Have a project in mind? Send me a message or connect with me on social media.
            </motion.p>
